...
componentDidMount(){
  ...
  render() {
    return (
      ...
      :''}
      <div className="example" style={{display:'none',  height:document.documentElement.clientHeight+'px',lineHeight:document.documentElement.clientHeight+'px'}}> <Spin  size="large" /></div></div>
    );
  }
}
export default App;